...
var child_process_1__default = /*#__PURE__*/ _interopDefaultLegacy(
  child_process_1
);
...
var util = createCommonjsModule(function (module, exports) {
  ...
  function first(input, offset = 0) {
    return isArrayLike(input) && input.length > offset
      ? input[offset]
      : undefined;
  }
  exports.first = first;
  ...
  exports.objectToString = Object.prototype.toString.call.bind(
...
var argumentFilters = createCommonjsModule(function (module, exports) {
  ...
  function filterPrimitives(input, omit) {
    return (
      ...
      (!omit || !omit.includes(typeof input))
    );
  }
  ...
  const filterStringOrStringArray = (input) => {
    return (
      ...
      (Array.isArray(input) && input.every(exports.filterString))
    );
  };
...
var lineParser = createCommonjsModule(function (module, exports) {
  ...
  class RemoteLineParser extends LineParser {
    addMatch(reg, index, line) {
      return (
        /^remote:\s/.test(String(line)) && super.addMatch(reg, index, line)
      );
    }
...
var simpleGitOptions = createCommonjsModule(function (module, exports) {
  ...
  function createInstanceConfig(...options) {
    ...
    const config = Object.assign(
      Object.assign({ baseDir }, defaultOptions),
...
var taskOptions = createCommonjsModule(function (module, exports) {
  ...
  function trailingArrayArgument(args) {
    ...
    return argumentFilters.filterType(
      util.last(args, hasTrailingCallback ? 1 : 0),
...
var taskParser = createCommonjsModule(function (module, exports) {
  ...
  function parseStringResponse(result, parsers, ...texts) {
    texts.forEach((text) => {
      for (
        let lines = util.toLinesWithContent(text), i = 0, max = lines.length;
        i < max;
        i++
      ) {
        const line = (offset = 0) => {
    ...
    return {
      ...
      parser() {
        throw typeof error === "string"
          ? new taskConfigurationError.TaskConfigurationError(error)
          : error;
      },
    };
  }
...
var clean = createCommonjsModule(function (module, exports) {
  ...
  exports.CONFIG_ERROR_INTERACTIVE_MODE =
    "Git clean interactive mode is not supported";
  exports.CONFIG_ERROR_MODE_REQUIRED =
  ...
  const CleanOptionValues = new Set([
    "i",
    ...utils.asStringArray(Object.values(CleanOptions)),
  ]);
  function cleanWithOptionsTask(mode, customArgs) {
    ...
    if (!valid.options) {
      return task.configurationErrorTask(
        exports.CONFIG_ERROR_UNKNOWN_OPTION + JSON.stringify(mode)
      );
    }
  ...
  function cleanTask(mode, customArgs) {
    ...
    return {
      ...
      format: "utf-8",
      parser(text) {
        return CleanSummary.cleanSummaryParser(
          mode === CleanOptions.DRY_RUN,
          text
        );
      },
    };
  ...
  function isCleanOptionsArray(input) {
    return (
      Array.isArray(input) && input.every((test) => CleanOptionValues.has(test))
    );
  }
  ...
  function isCleanMode(cleanMode) {
    return (
      cleanMode === CleanOptions.FORCE || cleanMode === CleanOptions.DRY_RUN
    );
  }
...
var checkIsRepo = createCommonjsModule(function (module, exports) {
  ...
  (function (CheckRepoActions) {
    ...
    (CheckRepoActions =
      exports.CheckRepoActions || (exports.CheckRepoActions = {}))
  );
...
var api = createCommonjsModule(function (module, exports) {
  ...
  Object.defineProperty(exports, "CleanOptions", {
    enumerable: true,
    get: function () {
  ...
  Object.defineProperty(exports, "CheckRepoActions", {
    enumerable: true,
    get: function () {
      return checkIsRepo.CheckRepoActions;
    },
  });

  Object.defineProperty(exports, "ResetMode", {
    enumerable: true,
    get: function () {
      return reset.ResetMode;
    },
  });

  Object.defineProperty(exports, "GitConstructError", {
    enumerable: true,
    get: function () {
      return gitConstructError.GitConstructError;
    },
  });

  Object.defineProperty(exports, "GitError", {
    enumerable: true,
    get: function () {
  ...
  Object.defineProperty(exports, "GitResponseError", {
    enumerable: true,
    get: function () {
      return gitResponseError.GitResponseError;
    },
  });

  Object.defineProperty(exports, "TaskConfigurationError", {
    enumerable: true,
    get: function () {
      return taskConfigurationError.TaskConfigurationError;
    },
  });
});
...
var gitLogger = createCommonjsModule(function (module, exports) {
  ...
  src.default.formatters.L = (value) =>
    String(utils.filterHasLength(value) ? value.length : "-");
  ...
  function createLogger(
    ...
    const key = childLoggerName(
      utils.filterType(verbose, utils.filterString),
      debugDebugger,
      infoDebugger
    );
    ...
    function child(name) {
      return utils.append(
        ...
        createLogger(
          label,
          (debugDebugger && debugDebugger.extend(name)) || name
        )
      );
    }
...
var gitExecutorChain = createCommonjsModule(function (module, exports) {
  ...
  class GitExecutorChain {
    ...
    onFatalException(task, e) {
      const gitError =
        e instanceof api.GitError
          ? Object.assign(e, { task })
          : new api.GitError(task, e && String(e));
      this._chain = Promise.resolve();
    ...
    handleTaskData(
      ...
      return new Promise((done, fail) => {
        ...
        if (exitCode && stdErr.length) {
          logger.info(
            `exitCode=%s treated as error when then child process has written to stdErr`
          );
    ...
    gitResponse(command, args, outputHandler, logger) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((done) => {
          ...
          const spawned = child_process_1__default["default"].spawn(
            command,
            args,
            spawnOptions
          );
...
var gitExecutor = createCommonjsModule(function (module, exports) {
  ...
  class GitExecutor {
    constructor(binary = "git", cwd, _scheduler) {
      ...
      this.cwd = cwd;
      this._scheduler = _scheduler;
      this._chain = new gitExecutorChain.GitExecutorChain(
        this,
        this._scheduler
      );
    }
...
var parseBranchDelete = createCommonjsModule(function (module, exports) {
  ...
  const parseBranchDeletions = (stdOut) => {
    return utils.parseStringResponse(
      new BranchDeleteSummary.BranchDeletionBatch(),
      parsers,
      stdOut
    );
  };
  ...
  function hasBranchDeletionError(data, processExitCode) {
    return (
      processExitCode === utils.ExitCodes.ERROR && deleteErrorRegex.test(data)
    );
  }
...
var parseBranch = createCommonjsModule(function (module, exports) {
  ...
  function parseBranchSummary(stdOut) {
    return utils.parseStringResponse(
      new BranchSummary.BranchSummaryResult(),
      parsers,
      stdOut
    );
  }
...
var branch = createCommonjsModule(function (module, exports) {
  ...
  function deleteBranchTask(branch, forceDelete = false) {
    const task = {
      ...
      parser(stdOut, stdErr) {
        return parseBranchDelete.parseBranchDeletions(stdOut, stdErr).branches[
          branch
        ];
      },
      onError(exitCode, error, _, fail) {
        ...
        throw new gitResponseError.GitResponseError(
          task.parser(error, ""),
          error
        );
      },
...
var parseListLogSummary = createCommonjsModule(function (module, exports) {
  ...
  function createListLogSummaryParser(
    splitter = exports.SPLITTER,
    fields = defaultFieldNames
  ) {
    return function (stdOut) {
      const all = utils
        .toLinesWithContent(stdOut, true, exports.START_BOUNDARY)
        .map(function (item) {
...
var parseMerge = createCommonjsModule(function (module, exports) {
    ...
    new utils.LineParser(
      ...
      (summary, [reason, file]) => {
        summary.conflicts.push(
          new MergeSummary.MergeSummaryConflict(reason, file)
        );
      }
    ),
    new utils.LineParser(
      ...
      (summary, [reason, file, deleteRef]) => {
        summary.conflicts.push(
          new MergeSummary.MergeSummaryConflict(reason, file, { deleteRef })
        );
      }
    ),
    new utils.LineParser(/^CONFLICT\s+\((.+)\):/, (summary, [reason]) => {
      summary.conflicts.push(
        new MergeSummary.MergeSummaryConflict(reason, null)
      );
    }),
    new utils.LineParser(
  ...
  const parseMergeResult = (stdOut, stdErr) => {
    return Object.assign(
      exports.parseMergeDetail(stdOut, stdErr),
  ...
  const parseMergeDetail = (stdOut) => {
    return utils.parseStringResponse(
      new MergeSummary.MergeSummaryDetail(),
      parsers,
      stdOut
    );
  };
...
var parsePush = createCommonjsModule(function (module, exports) {
  ...
  const parsers = [
    ...
    new utils.LineParser(
      ...
      (result, [local]) => {
        result.ref = Object.assign(Object.assign({}, result.ref || {}), {
          local,
        });
      }
    ),
  ...
  const parsePushResult = (stdOut, stdErr) => {
    ...
    const responseDetail = parseRemoteMessages_1.parseRemoteMessages(
      stdOut,
      stdErr
    );
...
var remote = createCommonjsModule(function (module, exports) {
  ...
  function addRemoteTask(remoteName, remoteRepo, customArgs = []) {
    return task.straightThroughStringTask([
      "remote",
      "add",
      ...customArgs,
      remoteName,
...
var stashList = createCommonjsModule(function (module, exports) {
  ...
  function stashListTask(opt = {}, customArgs) {
    ...
    const parser = parseListLogSummary.createListLogSummaryParser(
      options.splitter,
      options.fields
    );
    return {
...
var StatusSummary_1 = createCommonjsModule(function (module, exports) {
  ...
  const parseStatusSummary = function (text) {
    ...
    for (let i = 0, l = lines.length; i < l; i++) {
      ...
      if (file.code !== "##") {
        status.files.push(
          new FileStatusSummary_1.FileStatusSummary(
            file.path,
            file.index,
            file.workingDir
          )
    ...
    typeof workingDirectory !== "string"
      ...
      : adhocExecTask(() => {
          if (!folderExists(workingDirectory)) {
            throw new Error(
              `Git.cwd: cannot change to non-directory "${workingDirectory}"`
            );
          }
...
function createCloneTask(api, task, repoPath, localPath) {
  ...
  return task(
    repoPath,
    filterType(localPath, filterString),
...
Git.prototype.commit = function (message, files, options, then) {
  ...
  return this._runTask(
    commitTask(
      ...
      [
        ...filterType(options, filterArray, []),
...
Git.prototype.revert = function (commit) {
  ...
  return this._run(
    ["revert", ...getTrailingOptions(arguments, 0, true), commit],
    next
  );
};
  ...
  const task = pushTask(
    {
      ...
      branch: filterType(branch, filterString),
    },
    getTrailingOptions(arguments)
  );
  return this._runTask(task, trailingFunctionArgument(arguments));
...
Git.prototype.log = function (options) {
  ...
  return this._runTask(
    logTask(
      parsedOptions.splitter,
      parsedOptions.fields,
      parsedOptions.commands
    )
  );
};
...
Git.prototype.checkIgnore = function (pathnames, then) {
  return this._run(
    [
      "check-ignore",
      ...asArray(filterType(pathnames, filterStringOrStringArray, [])),
    ],
    trailingFunctionArgument(arguments),
    {
...
var gitFactory = createCommonjsModule(function (module) {
  ...
  for (
    let imported = api, keys = Object.keys(imported), i = 0;
    i < keys.length;
    i++
  ) {
    const name = keys[i];
  ...
  module.exports.gitInstanceFactory = function gitInstanceFactory(
    baseDir,
    options
  ) {
...
var promiseWrapped = createCommonjsModule(function (module, exports) {
  ...
  function gitP(...args) {
    ...
    const promiseApi = [
      ...
      const valid = isAsync
        ? asyncWrapper(name, git)
        : syncWrapper(name, git, api);
...
var src$2 = esModuleFactory(gitExportFactory(gitInstanceFactory, { gitP }));
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            this.registerInterval(
              window.setInterval(function () {
                return _this.statusBar.display();
              }, 1000)
            );
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              this.pull().then(function (filesUpdated) {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          this.getFilesChanged().then(function (files) {
                            return __awaiter(
                              _this,
                              void 0,
                              void 0,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.git.add("./*", function (err) {
                return (
                  err && _this.displayError("Cannot add files: " + err.message)
                );
              }),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.formatCommitMessage(this.settings.commitMessage),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.git.pull(null, null, null, function (err) {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 3:
            ...
            chunks = [];
            for (
              _i = 0, _a = Object.entries(changeset_1);
              _i < _a.length;
              _i++
            ) {
  ...
  ObsidianGitSettingsTab.prototype.display = function () {
          ...
          .onChange(function (value) {
            if (!isNaN(Number(value))) {
              ...
              if (plugin.settings.autoSaveInterval > 0) {
                ...
                new obsidian.Notice(
                  "Automatic backup enabled! Every " +
    ...
    new obsidian.Setting(containerEl)
      ...
      .addButton(function (button) {
        return button.setButtonText("Preview").onClick(function () {
          return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  return [
                    4 /*yield*/,
                    plugin.formatCommitMessage(plugin.settings.commitMessage),
                  ];
                case 1:
      ...
      .addDropdown(function (dropdown) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              case 0:
                return [4 /*yield*/, plugin.git.branchLocal()];
              case 1:
                branchInfo = _b.sent();
                ...
                dropdown.onChange(function (option) {
                  return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          return [
                            4 /*yield*/,
                            plugin.git.checkout(option, [], function (err) {
                              return __awaiter(
                                _this,
                                void 0,
                                void 0,
