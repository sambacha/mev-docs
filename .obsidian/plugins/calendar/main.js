...
function getNotePath(directory, filename) {
  ...
  return obsidian__default["default"].normalizePath(
    path__default["default"].join(directory, filename)
  );
}
/**
...
function getDailyNoteSettings() {
  ...
  try {
    ...
    var settings =
      window.app.internalPlugins.plugins["daily-notes"].instance.options;
    return {
      format: settings.format || DEFAULT_DATE_FORMAT,
      folder:
        ((_a = settings.folder) === null || _a === void 0
          ? void 0
          : _a.trim()) || "",
      template:
        ((_b = settings.template) === null || _b === void 0
          ? void 0
          : _b.trim()) || "",
    };
  } catch (err) {
        ...
        case 2:
          ...
          return [
            ...
            vault.create(
              normalizedPath,
              templateContents
                .replace(/{{\s*(date|time)\s*:(.*?)}}/gi, function (
                  _,
                  _timeOrDate,
                  momentFormat
                ) {
...
function getAllDailyNotes() {
  ...
  var _a = getDailyNoteSettings(),
    format = _a.format,
    folder = _a.folder;
  var dailyNotesFolder = vault.getAbstractFileByPath(
  ...
  for (let _day = 0; _day < 42; _day++) {
    ...
    week.days.push({
      ...
      isActive:
        activeFile &&
        activeFile ===
          (note === null || note === void 0 ? void 0 : note.basename),
  ...
  return {
    c() {
      ...
      attr(
        div1,
        "data-tags",
        (div1_data_tags_value = /*tags*/ ctx[5].join(" "))
      );
      toggle_class(
        div1,
        "adjacent-month",
        !(/*date*/ ctx[1].isSame(/*displayedMonth*/ ctx[8], "month"))
      );
      ...
      toggle_class(
        div1,
        "today",
        /*date*/ ctx[1].isSame(/*today*/ ctx[9], "day")
      );
    },
    m(target, anchor) {
    ...
    p(new_ctx, [dirty]) {
      ...
      if (
        dirty & /*date*/ 2 &&
        t0_value !== (t0_value = /*date*/ ctx[1].format("D") + "")
      )
      ...
      if (
        dirty & /*numTasksRemaining*/ 8 &&
        promise_1 !== (promise_1 = /*numTasksRemaining*/ ctx[3]) &&
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props) => {
    ...
    if ("numTasksRemaining" in $$props)
      $$invalidate(3, (numTasksRemaining = $$props.numTasksRemaining));
    ...
    if ("openOrCreateDailyNote" in $$props)
      $$invalidate(7, (openOrCreateDailyNote = $$props.openOrCreateDailyNote));
    if ("displayedMonth" in $$props)
      $$invalidate(8, (displayedMonth = $$props.displayedMonth));
...
function create_fragment$1(ctx) {
  ...
  handle_promise(
    (promise = getNumberOfDots(/*weeklyNote*/ ctx[0], /*settings*/ ctx[2])),
    info
  );
  ...
  handle_promise(
    (promise_1 = getNumberOfRemainingTasks(/*weeklyNote*/ ctx[0])),
    info_1
  );
  ...
  return {
    ...
    p(new_ctx, [dirty]) {
      ...
      if (
        dirty & /*weeklyNote, settings*/ 5 &&
        promise !==
          (promise = getNumberOfDots(
            /*weeklyNote*/ ctx[0],
            /*settings*/ ctx[2]
          )) &&
        handle_promise(promise, info)
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*activeFile, weeklyNote*/ 513) {
      $$invalidate(
        ...
        (isActive =
          activeFile &&
          (weeklyNote === null || weeklyNote === void 0
            ? void 0
...
function create_each_block_2(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      if (
        dirty & /*daysOfWeek*/ 128 &&
        t_value !== (t_value = /*dayOfWeek*/ ctx[22] + "")
      )
        set_data(t, t_value);
    },
    d(detaching) {
  ...
  return {
    ...
    p(ctx, dirty) {
      const weeknum_changes =
        dirty &
        /*month, activeFile, onHover, openOrCreateWeeklyNote, settings*/ 118
...
function create_each_block_1(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      const day_changes =
        dirty &
        /*month, onHover, openOrCreateDailyNote, today, displayedMonth*/ 333
...
function create_fragment$2(ctx) {
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (
        dirty &
        /*month, onHover, openOrCreateDailyNote, today, displayedMonth, activeFile, openOrCreateWeeklyNote, settings*/ 383
      ) {
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props) => {
    if ("activeFile" in $$props)
      $$invalidate(1, (activeFile = $$props.activeFile));
    if ("onHover" in $$props) $$invalidate(2, (onHover = $$props.onHover));
    if ("displayedMonth" in $$props)
      $$invalidate(0, (displayedMonth = $$props.displayedMonth));
    if ("openOrCreateDailyNote" in $$props)
      $$invalidate(3, (openOrCreateDailyNote = $$props.openOrCreateDailyNote));
    if ("openOrCreateWeeklyNote" in $$props)
      $$invalidate(
        4,
        (openOrCreateWeeklyNote = $$props.openOrCreateWeeklyNote)
...
class CalendarView extends obsidian.ItemView {
  ...
  async onOpen() {
    ...
    const activeFile = activeLeaf
      ? (_a = activeLeaf.view.file) === null || _a === void 0
        ? void 0
        : _a.path
      : null;
  ...
  async redraw() {
    ...
    if (this.calendar) {
      ...
      if (view instanceof obsidian.FileView) {
        activeFile =
          (_a = view.file) === null || _a === void 0 ? void 0 : _a.basename;
      }
...
class CalendarPlugin extends obsidian.Plugin {
  ...
  async onload() {
    ...
    this.registerView(
      VIEW_TYPE_CALENDAR,
      (leaf) => (this.view = new CalendarView(leaf, this.options))
    );
    this.addCommand({
