...
var SlidingPanesPlugin = /** @class */ (function (_super) {
  ...
  function SlidingPanesPlugin() {
    ...
    _this.reallyEnable = function () {
      ...
      _this.rootSplitAny.oldOnChildResizeStart =
        _this.rootSplitAny.onChildResizeStart;
    ...
    _this.updateStyle = function () {
      ...
      document.body.classList.toggle(
        ...
        _this.settings.stackingEnabled
      );
      ...
      if (!el) throw "plugin-sliding-panes element not found!";
        ...
        el.innerText =
          "body.plugin-sliding-panes{--header-width:" +
          _this.settings.headerWidth +
          "px;}";
    ...
    _this.recalculateLeaves = function () {
      ...
      rootLeaves.forEach(function (leaf, i) {
        ...
        if (_this.settings.leafAutoWidth) {
          leaf.containerEl.style.width =
            rootContainerEl.clientWidth -
            (leafCount - 1) * _this.settings.headerWidth +
            "px";
        } else {
          leaf.containerEl.style.width = null;
        }
        ...
        leaf.containerEl.style.right = _this.settings.stackingEnabled
          ? (leafCount - i) * _this.settings.headerWidth -
    ...
    _this.positionSuggestionContainer = function (scNode) {
      ...
      // there is text
        ...
        var previousTokens = lineTokens
          .filter(function (token) {
            return token.start <= currentToken.start;
          })
          .reverse();
        var hashtagOrBracketsToken = previousTokens.find(function (token) {
          return token.string.contains("[") || token.string.contains("#");
        });
        if (hashtagOrBracketsToken) {
          // position the suggestion container to just underneath the end of the open brackets
          scCursorPosition = {
            line: cursorPosition.line,
            ch: hashtagOrBracketsToken.end,
          };
        } else {
  ...
  Object.defineProperty(SlidingPanesPlugin.prototype, "rootContainerEl", {
    get: function () {
      return this.rootSplitAny.containerEl;
    },
    enumerable: false,
    configurable: true,
  });
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            this.addCommand({
              ...
              callback: function () {
                // switch the setting, save and refresh
                _this.settings.stackingEnabled = !_this.settings
                  .stackingEnabled;
                _this.saveData(_this.settings);
                _this.refresh();
              },
            ...
            this.suggestionContainerObserver = new MutationObserver(function (
              mutations
            ) {
            ...
            this.suggestionContainerObserver.observe(
              observerTarget,
              observerConfig
            );
            return [2 /*return*/];
  ...
  SlidingPanesSettingTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle
          .setValue(!_this.plugin.settings.disabled)
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.leafAutoWidth)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.rotateHeaders)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.headerAlt)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.stackingEnabled)
          .onChange(function (value) {
